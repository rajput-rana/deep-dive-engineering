...
| **2️⃣** | [Relational Databases](./05-relational-databases.md) | Most common, ACID concepts |
| **3️⃣** | [Indexing](./02-indexing.md) | Performance optimization |
| **4️⃣** | [MongoDB](./06-mongodb-document-database.md) | Document database patterns |
