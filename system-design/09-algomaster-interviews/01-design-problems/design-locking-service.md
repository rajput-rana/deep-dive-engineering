...
Our system consists of a cluster of lock service nodes that clients interact with via an SDK. The cluster uses a consensus algorithm to maintain a consistent state in a persistent store.
