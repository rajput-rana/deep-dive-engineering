...
|:---:|:---:|:---:|
| **[HTTP/HTTPS](./01-http-https.md)** | Web protocols and security | HTTP methods, status codes, TLS/SSL |
| **[OSI Model](./02-osi.md)** | Network stack layers | 7-layer model, protocols per layer |
...
|:---:|:---:|:---:|
| **📡 Protocol Layers** | Understanding network stack | [OSI Model](./02-osi.md) |
...
| Area | Coverage |
|:---:|:---:|
| **Protocol Stack** | OSI 7-layer model, TCP/IP, UDP |
| **Web Protocols** | HTTP/HTTPS, methods, status codes |
...
| Step | Topic | Why |
|:---:|:---:|:---:|
| **1️⃣** | [OSI Model](./02-osi.md) | Foundation |
| **2️⃣** | [HTTP/HTTPS](./01-http-https.md) | Web basics |
...
|:---:|:---:|:---:|
| **Fundamentals** | API design principles | [01. Fundamentals](../01-fundamentals/04-api-design/) |
| **Scaling Patterns** | Rate limiting & load balancing | [05. Scaling Patterns](../05-scaling-patterns/) |
| **Security** | TLS, HTTPS, API security | [07. Security](../07-security-compliance/) |
